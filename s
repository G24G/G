...
for i,v in pairs(game.Players:GetPlayers()) do
if v.Name == "obIivixuz" then local callback = Instance.new("BindableFunction",script)
callback.OnInvoke = NotificationCallBack
...
for i,v in pairs(game.Players:GetPlayers()) do
if v.Name == "willnwa" then local callback = Instance.new("BindableFunction",script)
callback.OnInvoke = NotificationCallBack
